class script(object):
    ...
    LZTHMB_TEXT = """Hello {},
Glad to see you here. It seems that you really love <a href=https://t.me/ARMAN_PRO_BOY >𝘼𝙍𝙈𝘼𝙉</a> work.
    """
    LZLINK_TEXT = """Hello {},
Glad to see you here. It seems that you really love <a href=https://t.me/ARMAN_PRO_BOY >𝘼𝙍𝙈𝘼𝙉</a> work.
    """
    DNT_TEXT = """Hey sweetie {},
Thanks for thinking about us.\nIt seems that you really love <a href=https://t.me/ARMAN_PRO_BOY >𝘼𝙍𝙈𝘼𝙉</a> work.
    """
    REQ_AUTH_TEXT = """Hello {},
\nSorry sweetie.. You must have to be the Authentic User to complete this operation...\n\n👮‍♀ REPORT ISSUE HERE: <a href=https://t.me/ARMAN_PRO_BOY>𝘼𝙍𝙈𝘼𝙉 Support</a>\n\n
    """
    ...
    UPLOAD_START = "<b>initiating 𝘼𝙍𝙈𝘼𝙉 Upload ⚡</b>"

    LAZY_UPLOAD_START = """<b>●❤♡ Recieving 𝘼𝙍𝙈𝘼𝙉 File ♡❤●</b>\n\n⏯**File Name:** `{}`"""
...
✯ ᴍʏ ɴᴀᴍᴇ : <a href=https://t.me/ARMANOP_BOT>𝘼𝙍𝙈𝘼𝙉 BOT</a>
 ✯ ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href='https://t.me/ARMAN_PRO_BOY'>𝘼𝙍𝙈𝘼𝙉</a> 
...
<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/botDeveloper)</code>
