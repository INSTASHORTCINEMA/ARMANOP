...
URL = "bothehd-49d3a0f63014.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "bothehd-49d3a0f63014.herokuapp.com/".format(FQDN, PORT)
SLEEP_THRESHOLD = int(environ.get('SLEEP_THRESHOLD', '60'))
WORKERS = int(environ.get('WORKERS', '4'))
SESSION_NAME = str(environ.get('SESSION_NAME', 'bothehd'))
MULTI_CLIENT = False
...
if HAS_SSL:
    URL = "bothehd-49d3a0f63014.herokuapp.com/".format(FQDN)
else:
    URL = "bothehd-49d3a0f63014.herokuapp.com/".format(FQDN)
