...
async def doc(bot, update):
    try:
        ...
        await ms.edit("三 𝘗𝘳𝘦𝘱𝘢𝘳𝘪𝘯𝘨 𝘵𝘰 𝘳𝘦𝘤𝘦𝘪𝘷𝘦 𝘼𝙍𝙈𝘼𝙉 𝘧𝘪𝘭𝘦...︻デ═一")
        c_time = time.time() 
        try:
           if type == "document":
              await bot.send_document(
	            update.message.chat.id,
                       ...
                       caption=caption, 
                       progress=progress_for_pyrogram,
                       progress_args=( "**⎝⎝✧ ʀᴇᴄɪᴇᴠɪɴɢ ꜰɪʟᴇ ꜰʀᴏᴍ 𝘼𝙍𝙈𝘼𝙉 ꜱᴇʀᴠᴇʀ ✧⎠⎠**",  ms, c_time))
           elif type == "video": 
...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/+IZRtADt3oXAwZGY1'),
        ] 
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love 𝘼𝙍𝙈𝘼𝙉 ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You 𝘼𝙍𝙈𝘼𝙉♥️')
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔔 Updates 🤖', url='https://t.me/+IZRtADt3oXAwZGY1')
        ], [
        ...
        await query.answer('♥️ Thank You 𝘼𝙍𝙈𝘼𝙉 ♥️')
        ...
        await query.answer("Thank You 𝘼𝙍𝙈𝘼𝙉")
        ...
        try:
            ...
            await log_msg.reply_text(
                ...
                quote=True,
                disable_web_page_preview=True,
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗", url=lazy_download),  # we download Link
        ...
        try:
            btn = [[
                InlineKeyboardButton(text=f"🔍 Search Here 🔎", url=f"https://t.me/+IZRtADt3oXAwZGY1")
            ],[
                InlineKeyboardButton(text=f"🐞 REPORT BUG 🐞", url=f"https://telegram.me/ARMAN_PRO_BOY")
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ʜᴏᴡ to ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/+IZRtADt3oXAwZGY1'),
        ] 
    )
