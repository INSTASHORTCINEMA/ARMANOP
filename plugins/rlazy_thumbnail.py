...
@Client.on_message(filters.private & filters.command(['view_pro_thumb','vpt']))
...
@Client.on_message(filters.private & filters.command(['del_pro_thumb','delete_pro_thumb','dpt']))
...
@Client.on_message(filters.private & filters.command(['set_pro_thumb','set_pro_thumbnail', 'spt']))
